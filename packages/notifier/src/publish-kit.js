...
export const UpdateCountShape = M.or(M.bigint(), M.number(), M.undefined());
...
export const makePublishKit = () => {
  ...
  const makeUpdateRecord = weakMemoizeUnary(
...
export const prepareDurablePublishKit = (baggage, kindName) => {
  ...
  // map for memoization.
  const makeUpdateRecord = makeUpdateRecordFromPublicationRecord;
